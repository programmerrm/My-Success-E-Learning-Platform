...
from .models import Banner_Section, Special_Fuature, Live_Class, Help_Line
...
class HelpLineAdmin(admin.ModelAdmin):
    list_display = ['team_leader', 'team_leader_whatup_number', 'telegram_url', 'any_kind_of_problem_date', 'any_kind_of_problem_google_meeting_url',  'trainer', 'trainer_whatup_number']
