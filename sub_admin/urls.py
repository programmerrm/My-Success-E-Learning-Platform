...
from .views import AllStudent, UpdatedProfile, ChangePassword, Withdrawal, Passbook, PendingStudent, TrainerCreate, TeamLeaderCreate, MemberInfo, AnySubAdminCreate
...
urlpatterns = [
    ...
    path('all-sub-admin/info/', AnySubAdminCreate.as_view(), name='all_sub_admin_info'),
